...
def generate_and_inspect_response(prover, problem, role, max_tokens=256, temperature=0.7):
...
# python3 pmv/inspect_traces.py runs/pure_stackelberg_experiment_20250729_095151/checkpoints/kirchner_round_005.pt --mode compare --num_samples 3
