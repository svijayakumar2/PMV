...
echo "Experiment: scaled_prover"
echo "Config: pmv/configs/experiments/config_scaled_prover.yaml"
echo ""

cd /dccstor/principled_ai/users/saranyaibm2/PMV || exit 1

python3 -u -m pmv.main pmv/configs/experiments/config_scaled_prover.yaml
