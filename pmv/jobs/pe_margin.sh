...
echo "Experiment: pe_margin"
echo "Config: pmv/configs/experiments/config_pe_margin.yaml"
echo ""

cd /dccstor/principled_ai/users/saranyaibm2/PMV || exit 1

python3 -u -m pmv.main pmv/configs/experiments/config_pe_margin.yaml
