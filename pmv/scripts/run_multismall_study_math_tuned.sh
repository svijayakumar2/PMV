#!/bin/bash
#BSUB -J pmv_multismall_math_tuned
#BSUB -q normal
...
# ============================================================
# Tuned math stabilization pass (defaults to single-3B supervised).
#
# Usage:
#   bsub < pmv/scripts/run_multismall_study_math_tuned.sh
#   VARIANTS=single_small_3b:1:supervised:small,multi_large_supervised:3:supervised:large \
#     bsub < pmv/scripts/run_multismall_study_math_tuned.sh
# ============================================================
...
echo ""
echo "Tuned math stabilization complete."
