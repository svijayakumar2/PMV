...
# ============================================================
# End-to-end PMV multismall study on math dataset.
#
# Usage:
#   bsub < pmv/scripts/run_multismall_study_math.sh
#   TRAIN_ROUNDS=1 BOOTSTRAP_EPISODES=16 COLLECT_EPISODES=24 \
#     PROBE_EPISODES=40 ATTACK_EPISODES=20 \
#     bsub < pmv/scripts/run_multismall_study_math.sh
# ============================================================
...
BASE_CONFIG=${BASE_CONFIG:-pmv/configs/experiments/config_multismall_study_math.yaml}
...
ATTACK_MAX_NEW_TOKENS=${ATTACK_MAX_NEW_TOKENS:-256}
...
OUT_DIR=${OUT_DIR:-results/studies/multi_small_math/${RUN_STAMP}_${LSB_JOBID:-local}}
