...
# ============================================================
# Stage 3: evaluate stage-2 checkpoints on harder Zebra (4x4)
# Usage:
#   bsub < scripts/run_stage3_eval_4x4.sh
#   EXPERIMENT=stage2_pe_min bsub < scripts/run_stage3_eval_4x4.sh
# ============================================================
...
OUT_DIR=${OUT_DIR:-results/stages/stage3_4x4_eval/${RUN_STAMP}_${LSB_JOBID:-local}}
...
for exp in ${EXPERIMENT_LIST}; do
  ...
  eval_out="${OUT_DIR}/eval_${exp}_zebra4x4.json"
  ...
  echo ""
  echo "============================================================"
  echo "STAGE3 EVAL: ${exp} on Zebra 4x4"
  echo "Config: ${cfg}"
